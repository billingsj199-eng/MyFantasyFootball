...
#
# Since 2026-09-14 the importer ALSO writes data/fpa_2026.js (+ .json twin for the extensions) (complete-league
...
$Files = @('data/weekly_stats_active.js', 'data/fpa_2026.js', 'data/fpa_2026.json', 'index.html')
